...
export default class VideoPlayer extends Component {
    ...
    renderTopControls() {
        ...
        return (
            <Animated.View
                ...
                <ImageBackground
                    source={require('../../assets/playerIcons/top-vignette.png')}
    ...
    renderBack() {
        return this.renderControl(
            <Image
                source={require('../../assets/playerIcons/back.png')}
            ...
            <View style={VideoPlayerstyles.volume.container}>
                ...
                <View
                    ...
                    <Image
                        ...
                        source={require('../../assets/playerIcons/volume.png')}
    ...
    renderFullscreen() {
        let source =
            this.state.isFullscreen === true
                ? require('../../assets/playerIcons/shrink.png')
                : require('../../assets/playerIcons/expand.png');
        return this.renderControl(
            <Image source={source} />,
            this.methods.toggleFullscreen,
    ...
    renderBottomControls() {
        ...
        return (
            <Animated.View
                ...
                <ImageBackground
                    source={require('../../assets/playerIcons/bottom-vignette.png')}
    ...
    /**
    * Render the Middle Controls - forward,pause/play,backward.
    */

    renderMiddleControls() {
        // const backwardControl = this.props.disableBackward
        //     ? this.renderNullControl()
        //     : this.renderTimer();
        const pausePlayControl = this.props.disablePlayPause
            ? this.renderNullControl()
            : this.renderPlay();
        // const forwardControl = this.props.disableForward
        //     ? this.renderNullControl()
        //     : this.renderPlayPause();
        ...
        return (
            <Animated.View
                ...
                {/* style={[VideoPlayerstyles.controls.row]} */}
                {/* imageStyle={[VideoPlayerstyles.controls.middle]}> */}
                {/* {backwardControl} */}
                <SafeAreaView
                    style={[VideoPlayerstyles.controls.row, VideoPlayerstyles.controls.middle]}>
                    {pausePlayControl}
                    {this.renderTitle()}
                    {/* {forwardControl} */}
                </SafeAreaView>
    ...
    renderPlayPause() {
        let source =
            this.state.paused === true
                ? require('../../assets/playerIcons/play.png')
                : require('../../assets/playerIcons/pause.png');
        return this.renderControl(
            <Image source={source} />,
            this.methods.togglePlayPause,
        ...
        if (this.state.loading) {
            return (
                <View style={VideoPlayerstyles.loader.container}>
                    <Animated.Image
                        source={require('../../assets/playerIcons/loader-icon.png')}
                        style={[
                    ...
                    <TouchableOpacity onPress={() => this.reloadPlayer()}>
                        <View style={{ justifyContent: 'center', alignItems: 'center', }}>
                            <Image
                                ...
                                source={require('../../assets/playerIcons/error-icon.png')}
            ...
            >
                {
                    this.state.player ? (
                                ...
                                <View style={{
                                    ...
                                    <TouchableOpacity onPress={() => this.playVideo()}>
                                        <Icon name={"play-circle-outline"}
                                            ...
                                            noBackground={true}
                                            color={'#fff'}
                                            backgroundSizeRatio={1} /></TouchableOpacity>
                                </View>
                            </View>
                        </View>
                    ) : (
                        <View style={[VideoPlayerstyles.player.container, this.styles.containerStyle]}>
                            ...
                            {this.state.error == false ? this.renderMiddleControls() : null}
