        ...
        <Screen>
            <Header
                ...
                right={<TouchableOpacity onPress={() => {
                    ...
                    <Texts color={colors.iondigoDye} size={17}>Done</Texts>
                </TouchableOpacity>}
            />
            <View>
                <TextField
                ...
                />
                <Header
                    left={<TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center' }}>
                        <Icon
                    ...
                    right={<TouchableOpacity onPress={() => { setIsPrivacyOptionsVisible(!isPrivacyOptionsVisible) }}>
                        <Icon
                            type='AntDesign'
                            name='caretright'
                            noBackground={true} />
